...
local function CreateStoneButton(stone)
	...
	frame:SetWidth(34)
	frame:SetHeight(34)
	frame:SetNormalTexture(b.norm) --("Interface\\AddOns\\Necrosis-Classic\\UI\\"..stone.."Button-01")
	frame:SetHighlightTexture(b.high) --("Interface\\AddOns\\Necrosis-Classic\\UI\\"..stone.."Button-0"..num)
	frame:RegisterForDrag("LeftButton")
	frame:RegisterForClicks("AnyUp")
	frame:Show()
