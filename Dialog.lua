...
Necrosis.AntiFear = {
	...
	["Buff"] = {
		GetSpellInfo(19337), --L["ANTI_FEAR_BUFF_FEAR_WARD"],	-- Dwarf priest racial trait
		GetSpellInfo(7744), --L["ANTI_FEAR_BUFF_FORSAKEN"],	-- Forsaken racial trait
		GetSpellInfo(12733), --L["ANTI_FEAR_BUFF_FEARLESS"],	-- Trinket
		GetSpellInfo(18499), --L["ANTI_FEAR_BUFF_BERSERK"],	-- Warrior Fury talent
		GetSpellInfo(1719), --L["ANTI_FEAR_BUFF_RECKLESS"],	-- Warrior Fury talent
		GetSpellInfo(12328), --L["ANTI_FEAR_BUFF_WISH"],		-- Warrior Fury talent
		GetSpellInfo(19574), --L["ANTI_FEAR_BUFF_WRATH"],		-- Hunter Beast Mastery talent
		GetSpellInfo(11958), --L["ANTI_FEAR_BUFF_ICE"],		-- Mage Ice talent
		GetSpellInfo(498), --L["ANTI_FEAR_BUFF_PROTECT"],	-- Paladin Holy buff
		GetSpellInfo(642), --L["ANTI_FEAR_BUFF_SHIELD"],		-- Paladin Holy buff
		GetSpellInfo(8143), --L["ANTI_FEAR_BUFF_TREMOR"],		-- Shaman totem
		GetSpellInfo(776), --L["ANTI_FEAR_BUFF_ABOLISH"],	-- Majordomo (NPC) spell
	},
	-- Debuffs and curses giving temporary immunity to fear effects
	["Debuff"] = {
		GetSpellInfo(704), --L["ANTI_FEAR_DEBUFF_RECKLESS"],	-- While under this curse the target ignores fear and horror
	}
	--[[
